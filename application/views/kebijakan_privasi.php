    ...
    <div class="container">
      <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
              ...
              <p style="font-size:14px;color:#5C5C5C;" class="text-center"><em><strong>Kebijakan Privasi</strong></em></p>
              ...
              <ul class="list-unstyled love">
                ...
                <br/>1. Definisi
                <br/>2. Informasi yang kami kumpulkan
                <br/>3. Penggunaan informasi yang kami kumpulkan
                <br/>4. Pemberian informasi yang kami kumpulkan
                <br/>5. Penahanan informasi yang kami kumpulkan
                <br/>6. Keamanan
                <br/>7. Perubahan atas Kebijakan Privasi ini
                <br/>8. Lain-lain
                <br/>9. Pengakuan dan persetujuan
                <br/>10. Berhenti menerima e-mail
                <br/>11. Cara untuk menghubungi kami</li>
                <li class="text-justify">Penggunaan anda atas aplikasi dan layanan kami tunduk pada Ketentuan Penggunaan dan
                Kebijakan Privasi ini dan mengindikasikan persetujuan anda terhadap Ketentuan Penggunaan
                dan Kebijakan Privasi tersebut.</li>

                <li class="text-justify">1. DEFINISI
                <br/>a. &quot;Kami&quot; berarti PT Traksi Indonesia Solusi, suatu perusahaan yang didirikan berdasarkan
                ...
                <li class="text-justify">2. INFORMASI YANG KAMI KUMPULKAN
                <br/>a. Kami mengumpulkan Informasi Pribadi tertentu dari anda agar Aplikasi dapat menemukan
                Layanan dari Penyedia Layanan. Anda akan langsung memberikan Informasi Pribadi (sebagai
                contoh, saat anda mendaftar) dan beberapa informasi akan secara otomatis dikumpulkan
                ketika anda menggunakan Aplikasi.
                <br/>b. Ketika anda mengunjungi Situs web kami, administrator situs web kami akan memproses data
                teknis seperti alamat IP anda, halaman web yang pernah anda kunjungi, browser internet yang anda gunakan, halaman web yang sebelumnya /selanjutnya anda kunjungi dan durasi setiap
                ...
                kesulitan-kesulitan teknis atau usaha yang mungkin timbul pada saat anda menggunakan
                ...
                <li class="text-justify">3. PENGGUNAAN INFORMASI YANG KAMI KUMPULKAN
                <br/>a. Kami menggunakan surel, nama, nomor telepon, dan sandi akun anda untuk memverifikasi
                kepemilikan anda atas suatu akun, untuk berkomunikasi dengan anda sehubungan dengan
                pesanan anda dan untuk memberikan anda informasi mengenai Aplikasi. Kami juga dapat
                menggunakan nama, surel, dan nomor telepon anda untuk mengirimkan pesan, pembaharuan
                ...
                pemrosesan data internal kami untuk memberikan Layanan yang lebih baik kepada anda.</li>
                ...
                Penyedia Layanan dapat menyimpan data anda di perangkat mereka dengan cara apapun.
                Kami tidak bertanggung jawab atas penyimpanan data dengan cara tersebut dan anda setuju
                ...
                pembatasan, layanan pemeliharaan, pengelolaan database, analisis web dan penyempurnaan
                fitur-fitur Situs web) atau untuk membantu kami dalam menganalisa bagaimana Layanan kami
                digunakan atau untuk penasihat profesional dan auditor eksternal kami, termasuk penasihat
                hukum, penasihat keuangan, dan konsultan-konsultan. Para pihak ketiga ini hanya memiliki
                ...
                pada ketentuan perundang-undangan, peraturan-peraturan dan pemerintah, atau dalam hal
                ...
                <br/>a. Kami tidak menjamin keamanan database kami dan kami juga tidak menjamin bahwa data
                yang anda berikan tidak akan ditahan/terganggu ketika sedang dikirimkan kepada kami. Setiap
                pengiriman informasi oleh anda kepada kami merupakan risiko anda sendiri. Anda tidak boleh
                mengungkapkan sandi anda kepada siapapun. Bagaimanapun efektifnya suatu teknologi, tidak
                ada sistem keamanan yang tidak dapat ditembus.</li>
                <li class="text-justify">7. PERUBAHAN ATAS KEBIJAKAN PRIVASI INI
                <br/>a. Kami dapat mengubah Kebijakan Privasi ini untuk mencerminkan perubahan dalam kegiatan
                kami. Jika kami mengubah Kebijakan Privasi ini, kami akan memberitahu anda melalui email
                atau dengan cara pemberitahuan di Situs web 1 hari sebelum perubahan berlaku. Kami
                menghimbau anda untuk meninjau halaman ini secara berkala untuk mengetahui informasi
                terbaru tentang bagaimana ketentuan Kebijakan Privasi ini kami berlakukan.M</li>
                <li class="text-justify">8. LAIN-LAIN
                <br/>a. Bahasa. Kebijakan Privasi ini dibuat dalam bahasa Inggris dan bahasa Indonesia, versi
                keduanya akan mengikat anda dan kami. Jika terdapat ketidaksesuaian antara versi bahasa
                Indonesia dan versi bahasa Inggris, maka versi bahasa Indonesia yang akan berlaku.
                <br/>b. Hukum yang mengatur dan yurisdiksi. Kebijakan Privasi ini diatur oleh dan untuk ditafsirkan
                dalam hukum Negara Republik Indonesia. Setiap dan seluruh sengketa yang timbul dari
                kebijakan privasi ini akan diatur oleh yurisdiksi eksklusif dari Pengadilan Negeri Jawa Barat.</li>
                <li class="text-justify">9. PENGAKUAN DAN PERSETUJUAN
                <br/>a. Dengan menggunakan Aplikasi, anda mengakui bahwa anda telah membaca dan memahami
                Kebijakan Privasi ini dan Ketentuan Penggunaan dan setuju dan sepakat terhadap
                penggunaan, praktek, pemrosesan dan pengalihan informasi pribadi anda oleh kami
                sebagaimana dinyatakan di dalam Kebijakan Privasi ini.
                <br/>b. Anda juga menyatakan bahwa anda memiliki hak untuk membagikan seluruh informasi yang
                telah anda berikan kepada kami dan untuk memberikan hak kepada kami untuk menggunakan
                dan membagikan informasi tersebut kepada Penyedia Layanan.</li>
                <li class="text-justify">10. BERHENTI MENERIMA E-MAIL
                <br/>a. Kami memiliki kebijakan untuk memilih masuk/keluar dari database. Jika Anda ingin berhenti
                menerima email dari kami, silahkan klik link unsubscribe yang disertakan pada masing-masing
                e-mail.</li>

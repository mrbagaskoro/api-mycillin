<?php
  ...
  class UserPatient extends Controlpatient {
    ...
    public function email_record_post() 
    {
          ...
          $user_data = $this->ma->is_valid_record_id($data['booking_id']);

        if ($user_data) {
            
                $this->email->from(EMAIL_ADDR, 'Lucy@MyCillin', EMAIL_ADDR);
                    $this->email->to($user_data->email);
                    $this->email->subject('[noreply] Your Mycillin Medical Record');
                    $this->email->set_mailtype("html");
                                              ...
                                              <tr>
                                                <td valign="top" class="body-cell">
                                                  ...
                                                  <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                                    <tr>
                                                      <td valign="top" style="padding-bottom:15px; background-color:#ffffff;">
                                                        <h1>Medical Record [Sangat Rahasia]</h1>
                                                      </td>
                                                    </tr>
                                                    <tr>
                                                      <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                        <b>Yth '.$user_data->user_name.',</b><br>
                                                        Informasi medical record ini merupakan data yang bersifat rahasia yang berisikan informasi riwayat penyakit yang pernah anda derita. Karena itu, Anda diharapkan menggunakan informasi secara bijak, dan segala penyalahgunaan informasi ini menjadi tanggung jawab Anda pribadi dan Anda setuju melepaskan mycillin dari segala tanggung jawab apapun sehubungan dengan penyalahgunaan informasi medical record ini.
                                                      </td>
                                                    </tr>
                                                    <tr>
                                                      <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                        ...
                                                        Suhu Badan : '.$user_data->body_temperature.'<br>
                                                        Kadar Gula Darah : '.$user_data->blood_sugar_level.'<br>
                                                        Kadar Kolesterol : '.$user_data->cholesterol_level.'<br>
                                                        Tekanan Darah (batas atas) : '.$user_data->blood_press_upper.'<br>
                                                        Tekanan Darah (batas bawah) : '.$user_data->blood_press_lower.'<br>
                                                        Kondisi Fisik : '.$user_data->patient_condition.'<br>
                                                        Diagnosa : '.$user_data->diagnosa.'<br>
                                                      </td>
                                                      </tr>
                                                       <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                        <b>Resep Obat (jika ada): </b><br>
                                                        Link Resep Obat : '.$user_data->prescription_img.'<br>   
                                                      </td>
                                                    </tr>
                                                    <tr>
                                                      <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                ...
                $this->success('Email medical record successfully sent');
